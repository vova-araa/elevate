...
// Pure helpers + types staan in report-data.ts (zonder jspdf-afhankelijkheid),
// zodat schermen die alleen tabellen tonen deze bundel niet hoeven te laden.
import {
